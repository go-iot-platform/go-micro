...
import (
	...
	"github.com/panovateam/go-micro/api/handler/rpc"
	"github.com/panovateam/go-micro/api/router"
	rregistry "github.com/panovateam/go-micro/api/router/registry"
	rstatic "github.com/panovateam/go-micro/api/router/static"
